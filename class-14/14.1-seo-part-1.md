...
Unfortunately, this tool requires a publicly accessible site, so we won't be able to use it on our local development sites. Instead, we'll walk through the steps for your future reference on other sites that you build after you deploy them.
