...
15. Click _Save_.
16. A confirmation appears noting that you are going to save changes to the Front Page Template and the Header Template Part. Note that you could choose to save the changes for only one of those using the checkboxes. Recall that Templates describe how an entire page appears and Template Parts describe how a small part of a page appears and can be used within Templates so that multiple templates can have consistency among those parts. Click _Save_ again to confirm.
