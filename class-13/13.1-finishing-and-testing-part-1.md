...
4. Delete the blocks containing the event schedule, sponsors, and speakers. Note that after deleting a block, the previous block is selected, so be sure to click the subsequent box before deleting it.
...
6. Remove _Join our mailing list to stay in the loop and get every news about WordCamp Nepal 2024_ and the _Subscribe Now_ button and insert a _Hustle: Embed_ block in their place.
...
13. Click _Publish_.
14. Return to the _Full Site Editor_ tab for the front page and choose the Hustle embed for the _Hustle: Embed_ block.
