...
* Videos:
  ...
  - History and High-Level Overview of WordPress
* Reading: 
  - Milestones, chapters 1-3
* Discussion: 
  - Introduce yourself
* Assignment:
...
* Assignment:
  ...
  - Install and configure two copies of WordPress (one for tutorial, one for your portfolio project; add a second user for nathaniel.laclaire@maine.edu)
