...
During our survey of content management systems, we briefly discussed the concept of inbound marketing. One important aspect of inbound marketing is capturing and nurturing leads. [_HubSpot Academy_](https://academy.hubspot.com/) provides several free lessons on lead nurturing and I also found a [great YouTube video](http://youtube.com/watch?v=HhWyOCOZ0p8) that provides a good overview of lead nurturing, so I won't go into the details here.
